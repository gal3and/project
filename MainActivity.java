...
public class MainActivity extends AppCompatActivity {
    ...
    TextView Text1, Datebtn1, Maintext;
    Button Btn1;
    EditText Edit1;
    Spinner Spinner1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                        ...
                        dlg1.setPositiveButton("입력",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) { //입력클릭을 동작하는곳
                                        ...
                                        Maintext.setText(String.format(re));
                                    }
                                });
                ...
                Spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                        ...
                        Maintext.append("\t \t \t");
                        Maintext.append(String.format(se));
                    }
                ...
                dlg.setPositiveButton("입력",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Maintext.append("\t \t \t");
                                Maintext.append(Edit1.getText().toString());
                            }
                        });
        ...
        Maintext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //MainActivity.Btn1.setOnClickListener(int );
            }
        });
