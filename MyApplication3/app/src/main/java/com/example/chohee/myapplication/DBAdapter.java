...
public class DBAdapter {
    ...
    public void insert_account(String Date, String item,String money) {
        try {
    ...
    public Cursor select_all_account() {
        Cursor c = db.query("account", //table name
                ...
                null, //group by
                null, //having
                "account_date" //order by
        );
        return c;
    }

    public ArrayList<String> get_all_account() {
       ...
       if(input_data.size()>1)
            ...
            itemlist.add(input_data.get(0).getDate()+"\t\t"+input_data.get(0).getItem()+"\t\t"+input_data.get(0).getMoney());
    ...
    ArrayList<String> item_Sorting(ArrayList<account_Data> input_data){
        ...
        Log.d("size",String.valueOf(input_data.size()));
            ...
            for(int i=0;i<input_data.size()-1;i++){
                ...
                itemlist.add(i,input_data.get(i).getDate()+"\t\t"+input_data.get(i).getItem()+"\t\t"+input_data.get(i).getMoney());
            }
